...
SERVER_INFO = {"name": "twinstudio", "version": "0.5.0"}
    ...
    return modern_result(
        {
            ...
            "instructions": (
                ...
                "selection scope, and a typed change plan; request human approval before applying changes. Feature-lens reviews generate alternatives only."
            ),
        },
        cacheable=True,
        ttl_ms=3_600_000,
